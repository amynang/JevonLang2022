...
Getting cocky now, we are going to throw the full dataset into the Dirichlet model. We now have 55 species with different leaf habits and mycorrhizal associations. I will cut a few corners here[^8], going directly to a model that includes relative height, habit and mycorrhizal group as well as their two-way interactions as predictors. We are also going to let the effect of height vary by species and study. We have a fairly sparse dataset with species information coming from more than one study/location while studies/locations feature more than one species. This sounds like a case for crossed random effects. But I think, *I think*, that we mainly want to account for variation across species and *then* species information that might vary from one study to another. I expect that variation across species overwhelms variation across studies. I will therefore nest studies within species for now.
...
![](figs/fig2.png){fig-align="center"}
